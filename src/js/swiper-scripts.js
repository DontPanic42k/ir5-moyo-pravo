...
let swiper_results_of_work = () => {
    ...
    document.querySelector('.page-bankruptcy-results-of-work-docs-slider .swiper-button-next').addEventListener('click', () => {
        swiper.slideNext();
    });

    document.querySelector('.page-bankruptcy-results-of-work-docs-slider .swiper-button-prev').addEventListener('click', () => {
        swiper.slidePrev();
    });
